...
function f() {
    var b1 = 42;
//    console.log(b);
    console.log(`inner variable b1 from inner context = ${b1}`);
    console.log(`outer variable a1 from inner context = ${a1}`);
}

f();

console.log(`outer variable form outer context a = ${a1}`);
